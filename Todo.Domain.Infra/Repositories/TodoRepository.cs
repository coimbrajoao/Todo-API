...
namespace Todo.Domain.Infra.Repositories
{
    public class TodoRepository : ITodoRepository
    {
        ...
        {
            return _context.Todos.AsNoTracking().Where(TodoQueries.GetAllByPeriod(user, date, done)).OrderBy(x => x.Date);
        }
        ...
        {
            return _context.Todos.FirstOrDefault(TodoQueries.GetById(user, id));
        }
